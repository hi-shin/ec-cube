...
# キャッシュのクリアと権限設定
sudo -u webapp bin/console cache:clear
sudo chown -R webapp:webapp var/cache var/log var/session var/data web/assets
sudo chmod -R 770 var/cache var/log var/session var/data web/assets

echo "EC-Cube setup completed."
